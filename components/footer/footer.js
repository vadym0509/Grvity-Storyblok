function getFooter(body){
    var content = `<div id="footer-container" class="w-full flex justify-center bg-[#F6F9FC]">
                        <div class="my-24 mx-8 w-full md:w-[719px] lg:w-[960px] xl:w-[1048px]">
                            <div class="sm:inline-flex w-full">
                                <div class="mr-10 md:mr-16 lg:mr-24 w-full sm:w-[126px] md:w-[158px] lg:w-auto">
                                    <img class="mt-3" src="${body.footer_logo.filename}" alt="${body.footer_logo.alt}">
                                    <div class="sm:hidden sm:block text-base text-[#797979] mt-4">${new Date().getFullYear()}&nbsp;&copy;&nbsp;GRVITY</div>
                                </div>
...
function getFooterItems(block){
    var content = `<div class="sm:w-1/2"><ul><li class="font-semibold text-2xl text-[#323B4B] mb-9">${block.title}</li>`
