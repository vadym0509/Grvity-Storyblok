function getSection(block, isShowShadow, indicatorNum){
    var content = `<div id="section-indicator-container-${indicatorNum}" class="relative w-fit top-[240px] z-[-1] font-bold text-[120px] md:text-[200px] leading-[180px] text-[#5B7FFF]" style="box-shadow:black 0px -35px 40px -50px inset">${indicatorNum}</div>
